...
pub enum ErrorKind {
    UnexpectedEnd,
    Unexpected(Pattern),
    Unclosed { start: Pattern, before_span: span::TSpan, before: Option<Pattern> },
    NoEndBranch,
}
...
impl Error {
    ...
    pub fn while_parsing(mut self, span: span::TSpan, structure: &'static str) -> Self {
...
impl Error {
    ...
    pub fn write<C: ariadne::Cache<usize>>(self, cache: C, writer: impl std::io::Write) {
